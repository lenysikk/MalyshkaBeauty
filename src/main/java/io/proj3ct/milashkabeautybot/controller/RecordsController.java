...
public class RecordsController {
    ...
    public class GlobalExceptionHandler {
        ...
        public ModelAndView handleEmptyResultDataAccessException(HttpServletRequest request, Exception ex) {
            ModelAndView modelAndView = new ModelAndView();
            modelAndView.setViewName("error"); // имя представления для отображения ошибки
            modelAndView.addObject("message", "Record not found"); // сообщение об ошибке
            return modelAndView;
        }
    }
}
